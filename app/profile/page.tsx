...
import { FaUser, FaLanguage, FaCrown, FaStar, FaClock, FaSyncAlt, FaTrophy } from "react-icons/fa";
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="py-4 px-8 bg-secondary rounded-lg">
          ...
          <p className="text-lg mb-2 flex items-center">
            <FaUser className="mr-2" /> <strong>Name:</strong> {userData.first_name}
          </p>
          <p className="text-lg mb-2 flex items-center">
            <FaLanguage className="mr-2" /> <strong>Language:</strong> {userData.language_code}
          </p>
          <p className="text-lg mb-2 flex items-center">
            <FaCrown className="mr-2" /> <strong>Premium User:</strong> {userData.is_premium ? "Yes" : "No"}
          </p>
        </div>
        <div className="p-4 bg-secondary rounded-lg">
          ...
          {recentGame ? (
            <div className="p-4 bg-white text-dark rounded-lg shadow-md">
              ...
              <p className="text-md mb-2 flex items-center">
                <FaTrophy className="mr-2" /> <strong>Result:</strong> {recentGame.isWin ? "Win" : "Loss"}
              </p>
            </div>
          ) : (
